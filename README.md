...
<!-- 
// Create a HTML structure with an Inline Event Handler onclick(assign a function for the userInput).

// Create a function createGrid() that generates grid
...
// Add a Default createGrid();

// Write the inline event Handler's function to get the userInput
